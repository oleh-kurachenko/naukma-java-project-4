 ...
 *
 */
public class SollArIPlayerPanel3 extends PlayerPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6559788898085142337L;
	 ...
	 * @param gameThread
	 */
	public SollArIPlayerPanel3(List<Integer> turn, int[][] gameTable, Thread gameThread,
			int number) {
		...
		label = new JLabel("SollArI.Gomoky 1.2");
